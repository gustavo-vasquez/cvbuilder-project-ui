			        ...
			        <Row className="h-100">
			            <Col md="7" className="my-auto">
			                <div className="header-content mx-auto">
			                    ...
			                    <a href="/" className="btn btn-outline btn-xl">Crear mi curriculum ahora <i className="fas fa-arrow-right"></i></a>
			                </div>
			            </Col>
			                    ...
			                    <div className="device-mockup ipad_air_2 portrait silver">
			                        <div className="device">
			                            <div className="screen">
			                                <Image src={modernTemplateImage} alt="cv_example" fluid />
			                            </div>
			                            <a href="#templates" className="button js-scroll-trigger" title="Ver todas las plantillas"> </a>
			                        </div>
			                    </div>
			                </div>
			            </Col>
